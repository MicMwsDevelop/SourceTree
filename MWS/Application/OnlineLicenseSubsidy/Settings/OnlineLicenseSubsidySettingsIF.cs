//
// OnlineLicenseSubsidySettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace OnlineLicenseSubsidy.Settings
{
	...
	/// 環境設定インターフェイス
	/// </summary>
	public static class OnlineLicenseSubsidySettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "OnlineLicenseSubsidySettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static OnlineLicenseSubsidySettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(OnlineLicenseSubsidySettings));
						Settings = serializer.Deserialize(fileStream) as OnlineLicenseSubsidySettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new OnlineLicenseSubsidySettings();
				}
			}
			return result;
		}
		...
		public static OnlineLicenseSubsidySettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as OnlineLicenseSubsidySettings;
		}
		...
		public static void SetSettings(OnlineLicenseSubsidySettings settings)
		{
			SetSettingsFileName();

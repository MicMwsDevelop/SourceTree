//
// OnlineElectricPrescriptEarningsFileSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace OnlineElectricPrescriptEarningsFile.Settings
{
	...
	/// 環境設定インターフェイス
	/// </summary>
	public static class OnlineElectricPrescriptEarningsFileSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "OnlineElectricPrescriptEarningsFileSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static OnlineElectricPrescriptEarningsFileSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(OnlineElectricPrescriptEarningsFileSettings));
						Settings = serializer.Deserialize(fileStream) as OnlineElectricPrescriptEarningsFileSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new OnlineElectricPrescriptEarningsFileSettings();
				}
			}
			return result;
		}
		...
		public static OnlineElectricPrescriptEarningsFileSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as OnlineElectricPrescriptEarningsFileSettings;
		}
		...
		public static void SetSettings(OnlineElectricPrescriptEarningsFileSettings settings)
		{
			SetSettingsFileName();

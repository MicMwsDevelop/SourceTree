//
// NoticeOnlineLicenseConfirmSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace NoticeOnlineLicenseConfirm.Settings
{
	...
	/// 環境設定インターフェイス
	/// </summary>
	public static class NoticeOnlineLicenseConfirmSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "NoticeOnlineLicenseConfirmSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static NoticeOnlineLicenseConfirmSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(NoticeOnlineLicenseConfirmSettings));
						Settings = serializer.Deserialize(fileStream) as NoticeOnlineLicenseConfirmSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new NoticeOnlineLicenseConfirmSettings();
				}
			}
			return result;
		}
		...
		public static NoticeOnlineLicenseConfirmSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as NoticeOnlineLicenseConfirmSettings;
		}
		...
		public static void SetSettings(NoticeOnlineLicenseConfirmSettings settings)
		{
			SetSettingsFileName();

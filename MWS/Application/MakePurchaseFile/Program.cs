...
//  1:りすとん月額仕入データファイル←サービス終了（2024/12）
//  2:Microsoft365仕入データファイル
//  3:問心伝月額仕入データファイル←サービス終了（2025/03）
//  4:Curline本体アプリ仕入データファイル←サービス終了（2023/07）
//  5:ナルコーム仕入データファイル
...
namespace MakePurchaseFile
{
	static class Program
	{
		...
		/// プログラムバージョン
		/// </summary>
		public const string gVersionStr = "Ver1.09(2025/04/09)";

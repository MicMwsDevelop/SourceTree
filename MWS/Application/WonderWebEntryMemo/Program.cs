...
//                   更新日:2023/07/10
//
// 4:CSVファイルによるメモ追加機能の追加
//    目的：オン資関連のメモ登録はこれまでシステム管理部で行っていたが、企画推進部で作業できるようCSVファイルによるインポート機能を追加。
//    使用者：企画推進部
//    使用時期：随時
//    入力ファイル：任意のファイル名.csv
//    出力ファイル：無
//    印刷物：無
//    メール送信：無
//    メモ文字列：【MICオンライン資格確認保守サービス案内（NTT）】
//						サービス証明書メール送信済
//						送信日：2024/06/XX
//
//						【オンライン請求進捗管理】
...
namespace WonderWebEntryMemo
{
	static class Program
	{
		...
		/// プログラムバージョン
		/// </summary>
		public const string ProgramVersion = "Ver1.04 2024/06/18";

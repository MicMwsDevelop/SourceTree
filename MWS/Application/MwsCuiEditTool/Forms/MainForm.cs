...
using CommonLib.DB.SqlServer.MwsCuiEditTool;
using System;
...
namespace MwsCuiEditTool.Forms
{
	public partial class MainForm : Form
	{
...
#if DEBUG
			textBoxCustomerNo.Text = "10000002";
#endif
		}
		...
		private void buttonSearch_Click(object sender, EventArgs e)
		{
			...
			// 顧客利用情報の設定
			DataTable table = MwsCuiEditToolAccess.GetDataTable_EditCustomerUseInformation(customerNo, Program.gSettings.ConnectCharlie.ConnectionString);
		...
		private void dataGridViewCui_MouseDoubleClick(object sender, MouseEventArgs e)
		{
			...
			if (null != cui)
			{
				using (EditForm dlg = new EditForm())
				{
					dlg.SetCUI(cui);

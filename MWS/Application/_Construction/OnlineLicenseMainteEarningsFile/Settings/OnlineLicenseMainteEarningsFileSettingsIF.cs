//
// OnlineLicenseMainteEarningsFileSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace OnlineLicenseMainteEarningsFile.Settings
{
	...
	/// 環境設定インターフェイス
	/// </summary>
	public static class OnlineLicenseMainteEarningsFileSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "OnlineLicenseMainteEarningsFileSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static OnlineLicenseMainteEarningsFileSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(OnlineLicenseMainteEarningsFileSettings));
						Settings = serializer.Deserialize(fileStream) as OnlineLicenseMainteEarningsFileSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new OnlineLicenseMainteEarningsFileSettings();
				}
			}
			return result;
		}
		...
		public static OnlineLicenseMainteEarningsFileSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as OnlineLicenseMainteEarningsFileSettings;
		}
		...
		public static void SetSettings(OnlineLicenseMainteEarningsFileSettings settings)
		{
			SetSettingsFileName();

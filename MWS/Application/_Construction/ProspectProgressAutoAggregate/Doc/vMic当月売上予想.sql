...
/****** Object:  View [dbo].[vMic当月売上予想]    Script Date: 2021/05/10 12:19:38 ******/
SET ANSI_NULLS ON
GO
...
/*
    vMic当月売上予想
        ...
        ３．ＷＷ伝票のバリューパック伝票で納期が今月日付の売上未計上分（リース下取除く）
        ４．ＷＷ伝票のバリューパック以外の伝票で納期が今月日付の売上未計上分（リース下取除く）
        の金額（税抜き）を部門ごとに集計します

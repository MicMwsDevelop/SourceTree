//
// ElectricPrescriptionEarningsFileSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace ElectricPrescriptionEarningsFile.Settings
{
	/// <summary>
	/// 環境設定インターフェイス
	/// </summary>
	public static class ElectricPrescriptionEarningsFileSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "ElectricPrescriptionEarningsFileSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static ElectricPrescriptionEarningsFileSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(ElectricPrescriptionEarningsFileSettings));
						Settings = serializer.Deserialize(fileStream) as ElectricPrescriptionEarningsFileSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new ElectricPrescriptionEarningsFileSettings();
				}
			}
			return result;
		}
		...
		public static ElectricPrescriptionEarningsFileSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as ElectricPrescriptionEarningsFileSettings;
		}
		...
		public static void SetSettings(ElectricPrescriptionEarningsFileSettings settings)
		{
			SetSettingsFileName();

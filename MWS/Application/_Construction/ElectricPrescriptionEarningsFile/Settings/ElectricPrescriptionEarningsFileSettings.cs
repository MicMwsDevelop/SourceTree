//
// ElectricPrescriptionEarningsFileSettings.cs
// 
// 環境設定定義クラス
// 
...
namespace ElectricPrescriptionEarningsFile.Settings
{
	...
	/// 環境設定
	/// </summary>
	public class ElectricPrescriptionEarningsFileSettings : ICloneable, IEquatable<ElectricPrescriptionEarningsFileSettings>
	{
		/// <summary>
		/// 出力先フォルダ
		/// </summary>
		...
		/// デフォルトコンストラクタ
		/// </summary>
		public ElectricPrescriptionEarningsFileSettings()
        {
		...
		/// <returns>判定</returns>
		public bool Equals(ElectricPrescriptionEarningsFileSettings other)
		{
			if (other != null)
			{
		...
		{
			if (obj is ElectricPrescriptionEarningsFileSettings)
			{
				return this.Equals((ElectricPrescriptionEarningsFileSettings)obj);
			}
			else
			{

namespace ElectricPrescriptionEarningsFile.Forms
{
	partial class MainForm
	{
		...
		{
			this.buttonExecMode2 = new System.Windows.Forms.Button();
			this.buttonExecMode1 = new System.Windows.Forms.Button();
			...
			// buttonExecMode2
			// 
			this.buttonExecMode2.Location = new System.Drawing.Point(367, 153);
			this.buttonExecMode2.Name = "buttonExecMode2";
			this.buttonExecMode2.Size = new System.Drawing.Size(261, 45);
			this.buttonExecMode2.TabIndex = 19;
			this.buttonExecMode2.Text = "利用申込取消処理 実行";
			this.buttonExecMode2.UseVisualStyleBackColor = true;
			this.buttonExecMode2.Click += new System.EventHandler(this.buttonExecMode2_Click);
			// 
			// buttonExecMode1
			// 
			this.buttonExecMode1.Location = new System.Drawing.Point(13, 153);
			this.buttonExecMode1.Name = "buttonExecMode1";
			this.buttonExecMode1.Size = new System.Drawing.Size(261, 45);
			this.buttonExecMode1.TabIndex = 18;
			this.buttonExecMode1.Text = "売上データ作成処理 実行";
			this.buttonExecMode1.UseVisualStyleBackColor = true;
			this.buttonExecMode1.Click += new System.EventHandler(this.buttonExecMode1_Click);
			// 
			// textBoxPcaVer
			// 
			...
			this.textBoxPcaVer.TabIndex = 17;
			// 
			...
			this.textBoxExportFilename.TabIndex = 15;
			// 
			// textBoxFolder
			// 
			...
			this.Controls.Add(this.buttonExecMode2);
			this.Controls.Add(this.buttonExecMode1);
		...
		private System.Windows.Forms.Button buttonExecMode2;
		private System.Windows.Forms.Button buttonExecMode1;

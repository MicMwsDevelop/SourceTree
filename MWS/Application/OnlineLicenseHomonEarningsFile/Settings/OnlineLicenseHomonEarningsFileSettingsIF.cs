//
// OnlineLicenseHomonEarningsFileSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace OnlineLicenseHomonEarningsFile.Settings
{
	...
	/// 環境設定インターフェイス
	/// </summary>
	public static class OnlineLicenseHomonEarningsFileSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "OnlineLicenseHomonEarningsFileSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static OnlineLicenseHomonEarningsFileSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(OnlineLicenseHomonEarningsFileSettings));
						Settings = serializer.Deserialize(fileStream) as OnlineLicenseHomonEarningsFileSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new OnlineLicenseHomonEarningsFileSettings();
				}
			}
			return result;
		}
		...
		public static OnlineLicenseHomonEarningsFileSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as OnlineLicenseHomonEarningsFileSettings;
		}
		...
		public static void SetSettings(OnlineLicenseHomonEarningsFileSettings settings)
		{
			SetSettingsFileName();

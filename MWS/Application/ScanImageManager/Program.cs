...
// 
/////////////////////////////////////////////////////////
// アプリ管理サイト：APPID621 文書インデックス管理
// 処理概要：WWスキャンデータのインデックス情報作成
// （スキャンデータを所定フォルダに格納し、別途作成し所定フォルダに配置したインデクスファイルからインデクス情報(DB保持)を作成）
// 入力ファイル：\\sqlsv\data保存\文書イメージファイル(jpg, tif, pdfなど)
// 出力ファイル：無
// 印刷物：無
// メール送信：無
/////////////////////////////////////////////////////////

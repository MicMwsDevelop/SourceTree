//
// HardSubscriptEarningsFileSettings.cs
// 
// 環境設定定義クラス
// 
...
namespace HardSubscriptEarningsFile.Settings
{
	...
	/// 環境設定
	/// </summary>
	public class HardSubscriptEarningsFileSettings : ICloneable, IEquatable<HardSubscriptEarningsFileSettings>
	{
		/// <summary>
		/// 出力先フォルダ
		/// </summary>
		...
		/// デフォルトコンストラクタ
		/// </summary>
		public HardSubscriptEarningsFileSettings()
        {
		...
		/// <returns>判定</returns>
		public bool Equals(HardSubscriptEarningsFileSettings other)
		{
			if (other != null)
			{
		...
		{
			if (obj is HardSubscriptEarningsFileSettings)
			{
				return this.Equals((HardSubscriptEarningsFileSettings)obj);
			}
			else
			{

...
namespace HardSubscriptEarningsFile.Mail
{
	/// <summary>
	/// メール送信クラス
	/// </summary>
	public static class SendMailControl
	{
		...
		public static void SendMail(List<HardSubscriptEarningsOut> saleList, string formalFilename, Date useDate)
		{
			using (MailMessage msg = new MailMessage())
			{
				...
				msg.Body += string.Format(@"<div>"
							+ @"<p>業務管理部 業務課各位</p>"
							+ @"<p>ハードサブスクの期間更新と売上データを作成しました。<br>"
							+ @"<br>"

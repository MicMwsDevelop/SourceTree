namespace AlmexMaintePurchaseFile.Forms
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Size = new System.Drawing.Size(664, 95);
			this.label3.TabIndex = 8;
			this.label3.Text = "本アプリはPCA売上データからアルメックス保守サービス商品を抽出し、仕入データのCSVファイルを出力します。\r\n※実行してもデータベースへのデータ変更はありません" +
    "。\r\n   サイレイトモードでの実行は引数に \"Auto\" を指定してください。";
			...
			this.Name = "MainForm";
			this.Text = "アルメックス保守サービス仕入データ作成  Ver1.00(2021/01/06)";

//
// OnlineLicenseSubsidyCustomerListSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace OnlineLicenseSubsidyCustomerList.Settings
{
	...
	/// 環境設定インターフェイス
	/// </summary>
	public static class OnlineLicenseSubsidyCustomerListSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "OnlineLicenseSubsidyCustomerListSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static OnlineLicenseSubsidyCustomerListSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(OnlineLicenseSubsidyCustomerListSettings));
						Settings = serializer.Deserialize(fileStream) as OnlineLicenseSubsidyCustomerListSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new OnlineLicenseSubsidyCustomerListSettings();
				}
			}
			return result;
		}
		...
		public static OnlineLicenseSubsidyCustomerListSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as OnlineLicenseSubsidyCustomerListSettings;
		}
		...
		public static void SetSettings(OnlineLicenseSubsidyCustomerListSettings settings)
		{
			SetSettingsFileName();

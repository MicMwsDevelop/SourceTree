...
namespace MwsServiceStatus.Settings
{
	...
	/// 環境設定
	/// </summary>
	public class MwsServiceStatusSettings : ICloneable, IEquatable<MwsServiceStatusSettings>
	{
		/// <summary>
		...
		/// デフォルトコンストラクタ
		/// </summary>
		public MwsServiceStatusSettings()
        {
		...
		/// <returns>判定</returns>
		public bool Equals(MwsServiceStatusSettings other)
		{
			if (other != null)
			{
		...
		{
			if (obj is MwsServiceStatusSettings)
			{
				return this.Equals((MwsServiceStatusSettings)obj);
			}
			else
			{

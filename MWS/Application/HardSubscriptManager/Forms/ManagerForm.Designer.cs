namespace HardSubscriptManager
{
	partial class ManagerForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonInputUseStartDate = new System.Windows.Forms.Button();
			this.buttonInputCancelDate = new System.Windows.Forms.Button();
			...
			// columnHeader10
			// 
			this.columnHeader10.Text = "解約受付日";
			...
			this.buttonDeleteHeader.Location = new System.Drawing.Point(498, 497);
			...
			this.buttonDeleteHeader.TabIndex = 22;
			...
			// 
			// buttonInputUseStartDate
			// 
			this.buttonInputUseStartDate.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			this.buttonInputUseStartDate.Location = new System.Drawing.Point(256, 497);
			this.buttonInputUseStartDate.Margin = new System.Windows.Forms.Padding(4, 3, 4, 3);
			this.buttonInputUseStartDate.Name = "buttonInputUseStartDate";
			this.buttonInputUseStartDate.Size = new System.Drawing.Size(113, 31);
			this.buttonInputUseStartDate.TabIndex = 20;
			this.buttonInputUseStartDate.Text = "利用開始日入力";
			this.buttonInputUseStartDate.UseVisualStyleBackColor = true;
			this.buttonInputUseStartDate.Click += new System.EventHandler(this.buttonInputUseStartDate_Click);
			// 
			// buttonInputCancelDate
			// 
			this.buttonInputCancelDate.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			this.buttonInputCancelDate.Location = new System.Drawing.Point(377, 497);
			this.buttonInputCancelDate.Margin = new System.Windows.Forms.Padding(4, 3, 4, 3);
			this.buttonInputCancelDate.Name = "buttonInputCancelDate";
			this.buttonInputCancelDate.Size = new System.Drawing.Size(113, 31);
			this.buttonInputCancelDate.TabIndex = 21;
			this.buttonInputCancelDate.Text = "解約日入力";
			this.buttonInputCancelDate.UseVisualStyleBackColor = true;
			this.buttonInputCancelDate.Click += new System.EventHandler(this.buttonInputCancelDate_Click);
			// 
			...
			this.Controls.Add(this.buttonInputCancelDate);
			this.Controls.Add(this.buttonInputUseStartDate);
		...
		private System.Windows.Forms.Button buttonInputUseStartDate;
		private System.Windows.Forms.Button buttonInputCancelDate;

//
// HardSubscriptManagerSettings.cs
// 
// 環境設定定義クラス
// 
...
namespace HardSubscriptManager.Settings
{
	...
	/// 環境設定
	/// </summary>
	public class HardSubscriptManagerSettings : ICloneable, IEquatable<HardSubscriptManagerSettings>
	{
		/// <summary>
		...
		/// デフォルトコンストラクタ
		/// </summary>
		public HardSubscriptManagerSettings()
        {
		...
		/// <returns>判定</returns>
		public bool Equals(HardSubscriptManagerSettings other)
		{
			if (other != null)
			{
		...
		{
			if (obj is HardSubscriptManagerSettings)
			{
				return this.Equals((HardSubscriptManagerSettings)obj);
			}
			else
			{

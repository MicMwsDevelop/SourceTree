//
// HardRentalEarningsFileSettings.cs
// 
// 環境設定定義クラス
// 
...
namespace HardRentalEarningsFile.Settings
{
	...
	/// 環境設定
	/// </summary>
	public class HardRentalEarningsFileSettings : ICloneable, IEquatable<HardRentalEarningsFileSettings>
	{
		/// <summary>
		/// 出力先フォルダ
		/// </summary>
		...
		/// デフォルトコンストラクタ
		/// </summary>
		public HardRentalEarningsFileSettings()
        {
		...
		/// <returns>判定</returns>
		public bool Equals(HardRentalEarningsFileSettings other)
		{
			if (other != null)
			{
		...
		{
			if (obj is HardRentalEarningsFileSettings)
			{
				return this.Equals((HardRentalEarningsFileSettings)obj);
			}
			else
			{

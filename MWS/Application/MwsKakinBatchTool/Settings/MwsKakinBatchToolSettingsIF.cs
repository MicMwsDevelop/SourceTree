//
// MwsKakinBatchToolSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace MwsKakinBatchTool.Settings
{
	...
	/// 環境設定インターフェイス
	/// </summary>
	public static class MwsKakinBatchToolSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "MwsKakinBatchToolSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static MwsKakinBatchToolSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(MwsKakinBatchToolSettings));
						Settings = serializer.Deserialize(fileStream) as MwsKakinBatchToolSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new MwsKakinBatchToolSettings();
				}
			}
			return result;
		}
		...
		public static MwsKakinBatchToolSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as MwsKakinBatchToolSettings;
		}
		...
		public static void SetSettings(MwsKakinBatchToolSettings settings)
		{
			SetSettingsFileName();

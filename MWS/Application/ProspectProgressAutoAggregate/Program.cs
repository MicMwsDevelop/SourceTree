...
namespace ProspectProgressAutoAggregate
{
	static class Program
	{
		...
		/// バージョン情報
		/// </summary>
		public static readonly string VersionStr = "Ver1.07 (2022/02/09)";
		...
		private static void 売上実績(XLWorkbook wb, int period, Date today, Span term)
		{
			if (47 == period)
			{
				...
				// 更新日
				ws1.Cell(2, 25).SetValue(string.Format("更新日：{0}", DateTime.Now.ToString()));
				...
				if (IsAfter202202(today))
				{
					...
					date = date.PlusMonths(1);
					売上実績_予算予測実績値設定_202202(ws2, date.ToIntYMD(), 6);  // 下期2月実績
					date = date.PlusMonths(1);
					売上実績_予算予測実績値設定_202202(ws2, date.ToIntYMD(), 16);  // 下期3月実績
					date = date.PlusMonths(1);
					売上実績_予算予測実績値設定_202202(ws2, date.ToIntYMD(), 26);  // 下期4月実績
					date = date.PlusMonths(1);
					売上実績_予算予測実績値設定_202202(ws2, date.ToIntYMD(), 44);  // 下期5月実績
					date = date.PlusMonths(1);
					売上実績_予算予測実績値設定_202202(ws2, date.ToIntYMD(), 54);  // 下期6月実績
					date = date.PlusMonths(1);
					売上実績_予算予測実績値設定_202202(ws2, date.ToIntYMD(), 64);  // 下期7月実績

					// 更新日
					ws2.Cell(2, 24).SetValue(string.Format("更新日：{0}", DateTime.Now.ToString()));
				}
			}
			else
			{
		...
		{
			string[] bumon1_2021 = { "081", "082", "083", "086", "087", "085" };			// 東日本営業部、首都圏営業部、関東営業部、中部営業部、関西営業部、西日本営業部
			string[] bumon2_2021 = { "081", "082", "083", "086", "087", "085", "011" };     // 東日本営業部、首都圏営業部、関東営業部、中部営業部、関西営業部、西日本営業部、営業管理部
			string[] bumon3_2021 = { "075", "081", "082", "083", "086", "087", "085" };     // ヘルスケア営業部、東日本営業部、首都圏営業部、関東営業部、中部営業部、関西営業部、西日本営業部

			string[] bumon1_2022 = { "045", "046", "053", "054", "055", "057", "058" };			// 東日本営業部、西日本営業部、東日本サポートセンター、首都圏サポートセンター、中日本サポートセンター、関西サポートセンター、西日本サポートセンター
			string[] bumon2_2022 = { "045", "046", "053", "054", "055", "057", "058", "011" };  // 東日本営業部、西日本営業部、東日本サポートセンター、首都圏サポートセンター、中日本サポートセンター、関西サポートセンター、西日本サポートセンター、営業管理部
			string[] bumon3_2022 = { "075", "045", "046", "053", "054", "055", "057", "058" };  // 企画推進部、東日本営業部、西日本営業部、東日本サポートセンター、首都圏サポートセンター、中日本サポートセンター、関西サポートセンター、西日本サポートセンター

			string[] bumon1, bumon2, bumon3;
			if (IsAfter202202(ym.ToDate(1)))
			{
				bumon1 = new string[bumon1_2022.Length];
				Array.Copy(bumon1_2022, bumon1, bumon1_2022.Length);
				bumon2 = new string[bumon2_2022.Length];
				Array.Copy(bumon2_2022, bumon2, bumon2_2022.Length);
				bumon3 = new string[bumon3_2022.Length];
				Array.Copy(bumon3_2022, bumon3, bumon3_2022.Length);
			}
			else
			{
				bumon1 = new string[bumon1_2021.Length];
				Array.Copy(bumon1_2021, bumon1, bumon1_2021.Length);
				bumon2 = new string[bumon2_2021.Length];
				Array.Copy(bumon2_2021, bumon2, bumon2_2021.Length);
				bumon3 = new string[bumon3_2021.Length];
				Array.Copy(bumon3_2021, bumon3, bumon3_2021.Length);
			}

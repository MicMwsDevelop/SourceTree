namespace CloudBackupPurchaseFile.Forms
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			// textBoxFilename
			// 
			this.textBoxFilename.Location = new System.Drawing.Point(189, 79);
			...
			// textBoxFolder
			// 
			this.textBoxFolder.Location = new System.Drawing.Point(189, 46);
			...
			this.label3.Size = new System.Drawing.Size(664, 78);
			this.label3.TabIndex = 8;
			this.label3.Text = "本アプリはPCA売上データからクラウドバックアップ商品を抽出し、仕入データのCSVファイルを出力します。\r\n※実行してもデータベースへのデータ変更はありません。\r" +
    "\n   サイレイトモードでの実行は引数に \"Auto\" を指定してください。";
			// 
			// buttonExec
			// 
			this.buttonExec.Location = new System.Drawing.Point(513, 205);
			...
			this.dateTimePickerMonth.Location = new System.Drawing.Point(189, 13);
			...
			// textBoxPcaVer
			// 
			this.textBoxPcaVer.Location = new System.Drawing.Point(189, 112);
			...
			this.Name = "MainForm";
			this.Text = "クラウドバックアップ仕入データ作成  Ver1.00(2020/10/23)";

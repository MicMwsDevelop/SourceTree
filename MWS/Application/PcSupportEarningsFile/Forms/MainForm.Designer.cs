namespace PcSupportEarningsFile.Forms
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "本アプリはPC安心サポート契約情報から当月末日で利用期間が終了するユーザーを検索し、売上データのCSVファイルを出力します。\r\n※実行後、PC安心サポート契約情報の利用期間が１年後に" +
    "更新されます。\r\n   サイレイトモードでの実行は引数に \"Auto\" を指定してください。";
			...
			this.Name = "MainForm";
			this.Text = "PC安心サポート継続売上データ作成  Ver1.00(2020/11/02)";

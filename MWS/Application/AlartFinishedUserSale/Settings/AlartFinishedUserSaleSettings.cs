//
// AlartFinishedUserSaleSettings.cs
// 
// 環境設定定義クラス
// 
...
namespace AlartFinishedUserSale.Settings
{
	...
	/// 環境設定
	/// </summary>
	public class AlartFinishedUserSaleSettings : ICloneable, IEquatable<AlartFinishedUserSaleSettings>
	{
		/// <summary>
		/// PCA売上データファイルパス
		/// </summary>
		...
		/// <returns>判定</returns>
		public bool Equals(AlartFinishedUserSaleSettings other)
		{
			if (other != null)
			{
		...
		{
			if (obj is AlartFinishedUserSaleSettings)
			{
				return this.Equals((AlartFinishedUserSaleSettings)obj);
			}
			else
			{

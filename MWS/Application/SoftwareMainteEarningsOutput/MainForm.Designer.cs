namespace SoftwareMainteEarningsOutput
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxSlipNo = new MwsLib.Component.NumericTextBox();
			this.SuspendLayout();
			// 
			// label1
			// 
    ...
    "\r\n   サイレイトモードでの実行は引数に \"Auto\" を指定してください。";
			...
			// buttonExec
			// 
			this.buttonExec.Location = new System.Drawing.Point(513, 222);
			...
			this.label5.Text = "売上伝票番号初期値";
			// 
			// textBoxSlipNo
			// 
			this.textBoxSlipNo.Location = new System.Drawing.Point(189, 111);
			this.textBoxSlipNo.MaxLength = 2;
			this.textBoxSlipNo.Name = "textBoxSlipNo";
			this.textBoxSlipNo.Size = new System.Drawing.Size(107, 27);
			this.textBoxSlipNo.TabIndex = 7;
			this.textBoxSlipNo.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// MainForm
			// 
			...
			this.Controls.Add(this.textBoxSlipNo);
		...
		private MwsLib.Component.NumericTextBox textBoxSlipNo;
	}
}

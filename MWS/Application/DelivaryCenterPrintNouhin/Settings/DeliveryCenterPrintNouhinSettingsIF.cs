//
// DeliveryCenterPrintNouhinSettingsIF.cs
// 
// 環境設定インターフェイス
// 
...
namespace DeliveryCenterPrintNouhin.Settings
{
	...
	/// </summary>
	public static class DeliveryCenterPrintNouhinSettingsIF
	{
		/// <summary>
		/// 環境設定ファイル名称
		/// </summary>
		public const string SETTINGS_FILENAME = "DeliveryCenterPrintNouhinSettings.xml";

		/// <summary>
		/// 環境設定
		/// </summary>
		private static DeliveryCenterPrintNouhinSettings Settings = null;
			...
			if (reload || null == Settings)
			{
				...
				if (true == File.Exists(SettingsFileName))
				{
					...
					try
					{
						...
						XmlSerializer serializer = new XmlSerializer(typeof(DeliveryCenterPrintNouhinSettings));
						Settings = serializer.Deserialize(fileStream) as DeliveryCenterPrintNouhinSettings;
					}
					catch (Exception)
					{
						result = false;
				...
				{
					// 存在しない場合は初期値を設定
					Settings = new DeliveryCenterPrintNouhinSettings();
				}
			}
			return result;
		}
		...
		public static DeliveryCenterPrintNouhinSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
			...
			return Settings.Clone() as DeliveryCenterPrintNouhinSettings;
		}
		...
		public static void SetSettings(DeliveryCenterPrintNouhinSettings settings)
		{
			SetSettingsFileName();

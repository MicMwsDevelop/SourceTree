...
namespace MwsLib.DB.SqlServer.Charlie
{
	public static class CharlieDatabaseAccess
	{
		...
		public static List<売上実績> Select_売上実績(string whereStr, string orderStr, bool ct)
		{
			DataTable table = SelectCharlieDatabase(CharlieDatabaseDefine.TableName[CharlieDatabaseDefine.TableType.売上実績], whereStr, orderStr, ct);

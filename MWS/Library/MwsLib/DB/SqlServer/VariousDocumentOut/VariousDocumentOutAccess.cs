...
namespace MwsLib.DB.SqlServer.VariousDocumentOut
{
	public static class VariousDocumentOutAccess
	{
		...
		/// <returns>結果</returns>
		public static List<SatelliteOffice> Select_SatelliteOfficeInfo(string userName, bool ct)
		{
		...
		/// <param name="ct">CT環境</param>
		/// <returns>結果</returns>
		public static List<SatelliteOffice> Select_HeadOfficeInfo(string userName, bool ct)
		{

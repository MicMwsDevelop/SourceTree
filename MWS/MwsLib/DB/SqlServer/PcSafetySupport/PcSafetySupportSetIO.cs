...
namespace MwsLib.DB.SqlServer.PcSafetySupport
{
	public static class PcSafetySupportSetIO
	{
					...
					using (SqlTransaction tran = con.BeginTransaction())
					{
						try
						{
							...
							SqlParameter[] param = { new SqlParameter("@1", data.CustomerID),						// fhsCliMicID
													...
													new SqlParameter("@3", data.CollectionDate.Value.ToDateTime()),	// fhsS契約書回収年月
													new SqlParameter("@4", null),									// fhsS売計上
													new SqlParameter("@5", data.AgreeYear),							// fhsS契約年数
													new SqlParameter("@6", data.Price),								// fhsSメンテ料金
													new SqlParameter("@7", data.StartDate.Value.ToDateTime()),		// fhsSメンテ契約開始
													new SqlParameter("@8", data.EndDate.Value.ToDateTime()),		// fhsSメンテ契約終了
					...
					using (SqlTransaction tran = con.BeginTransaction())
					{
						try
						{
							...
							SqlParameter[] param = { new SqlParameter("@1", (data.Subscription) ? '1': '0'),
													new SqlParameter("@2", data.CollectionDate.Value.ToDateTime()),
													new SqlParameter("@3", data.AgreeYear),
													new SqlParameter("@4", data.Price),
													new SqlParameter("@5", data.StartDate.Value.ToDateTime()),
													new SqlParameter("@6", data.EndDate.Value.ToDateTime()),
		...
		/// <summary>
		/// PC安心サポート管理情報の追加（T_PC_SUPPORT_CONTROL）
		/// </summary>
					...
					using (SqlTransaction tran = con.BeginTransaction())
					{
						try
						{
							...
							SqlParameter[] param = { new SqlParameter("@1", data.CustomerID),							// CUSTOMER_ID
													...
													new SqlParameter("@3", data.StartDate.Value.ToDateTime()),			// START_DATE
													new SqlParameter("@4", data.EndDate.Value.ToDateTime()),			// END_DATE
													new SqlParameter("@5", data.PeriodEndDate.Value.ToDateTime()),		// PERIOD_END_DATE
													...
													new SqlParameter("@10", data.ApplyDate.Value.ToDateTime()),			// APPLY_DATE
													...
													new SqlParameter("@15", data.StartMaleDate.Value.ToDateTime()),		// START_MALE_DATE
													new SqlParameter("@16", data.GuideMaleDate.Value.ToDateTime()),		// GUIDE_MALE_DATE
													new SqlParameter("@17", data.UpdateMaleDate.Value.ToDateTime()),	// UPDATE_MALE_DATE
													new SqlParameter("@18", data.CancelDate.Value.ToDateTime()),		// CANCEL_DATE
													new SqlParameter("@19", (data.CancelReportAccept) ? '1' : '0'),		// CANCEL_REPORT_ACCEPT
													new SqlParameter("@20", data.CancelReason),							// CANCEL_REASON
													new SqlParameter("@21", data.CreateDate.Value.ToDateTime()),		// CREATE_DATE
													new SqlParameter("@22", data.CreaatePerson),						// CREATE_PERSON
													new SqlParameter("@23", data.UpdateDate.Value.ToDateTime()),		// UPDATE_DATE
		...
		/// <summary>
		/// PC安心サポート管理情報の更新（T_PC_SUPPORT_CONTROL）
		/// </summary>
		/// <param name="data">PC安心サポート管理情報</param>
		/// <param name="sqlsv2">CT環境かどうか？</param>
		/// <returns>影響行数</returns>
			...
			using (SqlConnection con = new SqlConnection(DataBaseAccess.CreateJunpWebConnectionString(sqlsv2)))
			{
				try
				{
					...
					using (SqlTransaction tran = con.BeginTransaction())
					{
						try
						{
							string sqlString = string.Format(@"UPDATE T_PC_SUPPORT_CONTROL
																 SET GOODS_ID = @1
																, START_DATE = @2
																, END_DATE = @3
																, PERIOD_END_DATE = @4
							...
							SqlParameter[] param = { new SqlParameter("@1", data.GoodsID),
													new SqlParameter("@2", data.StartDate.Value.ToDateTime()),
													new SqlParameter("@3", data.EndDate.Value.ToDateTime()),
													new SqlParameter("@4", data.PeriodEndDate.Value.ToDateTime()),
													...
													new SqlParameter("@9", data.ApplyDate.Value.ToDateTime()),
													...
													new SqlParameter("@14", data.StartMaleDate.Value.ToDateTime()),
													new SqlParameter("@15", data.GuideMaleDate.Value.ToDateTime()),
													new SqlParameter("@16", data.UpdateMaleDate.Value.ToDateTime()),
													new SqlParameter("@17", data.CancelDate.Value.ToDateTime()),
													new SqlParameter("@18", (data.CancelReportAccept) ? '1' : '0'),
													new SqlParameter("@19", data.CancelReason),
													new SqlParameter("@20", data.CreateDate.Value.ToDateTime()),
													new SqlParameter("@21", data.CreaatePerson),
													new SqlParameter("@22", data.UpdateDate.Value.ToDateTime()),

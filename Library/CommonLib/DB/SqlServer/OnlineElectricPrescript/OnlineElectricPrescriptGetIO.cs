//
// OnlineElectricPrescriptGetIO.cs
//
// オン資電子処方箋連携契約情報 データ取得クラス
// 
...
{
	public static class OnlineElectricPrescriptGetIO
	{
		/// <summary>
		/// オン資電子処方箋連携契約情報の取得
		/// </summary>
		...
		public static DataTable GetOnlineElectricPrescriptEarningsOut(Date applyDate, string connectStr)
		{
			string strSQL = string.Format(@"SELECT"
									...
									+ " WHERE U.[終了フラグ] = '0' AND (H.[DeleteFlag] = '0' OR H.[DeleteFlag] is null) AND (CONVERT(int, CONVERT(NVARCHAR, H.[ApplyDate], 112)) between {4} AND {5})"
									+ " ORDER BY H.[ApplyNo]"

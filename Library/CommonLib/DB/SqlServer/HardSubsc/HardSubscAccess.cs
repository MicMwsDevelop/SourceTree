...
namespace CommonLib.DB.SqlServer.HardSubsc
{
	...
	public static  class HardSubscAccess
	{
		...
		public static int InsertIntoHardSubscHeader(T_HARD_SUBSC_HEADER header, string connectStr, string createPerson)
		{
			try
			{
		...
		public static int InsertIntoHardSubscDetailList(List<T_HARD_SUBSC_DETAIL> list, string connectStr, string createPerson)
		{
			try
			{
		...
		/// <returns>影響行数</returns>
		public static int UpdateSetHardSubscHeader(T_HARD_SUBSC_HEADER header, string connectStr, string updatePerson)
		{
			try
			{
		...
		/// <param name="updatePerson">更新者</param>
		/// <returns>影響行数</returns>
		public static int UpdateSetHardSubscHeader(HardSubscEarningsOut sale, bool serviceEndFlag, string connectStr, string updatePerson)
		{
			try
			{
		...
		public static List<HardSubscNotify> GetHardSubscNotify(Date useEndDate, string connectStr)
		{
			// 抽出条件
			// 終了フラグ = OFF(1)
			// サービス終了フラグ = OFF(2)

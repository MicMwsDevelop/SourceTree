//
// ElectricPrescriptionGetIO.cs
//
// 電子処方箋管理契約情報 データ取得クラス
// 
...
{
	public static class ElectricPrescriptionGetIO
	{
		/// <summary>
		/// 電子処方箋管理契約情報の取得
		/// </summary>
		...
		public static DataTable GetElectricPrescriptionEarningsOut(Date applyDate, string connectStr)
		{

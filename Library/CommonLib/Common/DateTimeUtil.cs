...
namespace CommonLib.Common
{
	...
	public static class DateTimeUtil
	{
		...
		/// <param name="dt">DateTime</param>
		/// <returns>Datetime</returns>
		public static DateTime BeginOfNextMonth(this DateTime dt)
		{
			return BeginOfMonth(dt.AddMonths(1));
		}
		...
		{
			return EndOfMonth(dt.AddMonths(1));
		}
		...
		/// <param name="dt">DateTime</param>
		/// <returns>Datetime</returns>
		public static DateTime BeginOfLastMonth(this DateTime dt)
		{
			return BeginOfMonth(dt.AddMonths(-1));
		}

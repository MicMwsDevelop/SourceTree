...
namespace CommonLib.BaseFactory.OnlineLicenseHomon
{
	...
	public class OnlineLicenseHomonEarningsOut
	{
		...
		/// </summary>
		public const string 連携費_商品コード = "018427";
		...
		/// デフォルトコンストラクタ
		/// </summary>
		public OnlineLicenseHomonEarningsOut()
		{
			受付No = 0;
			顧客No = 0;
			顧客名 = string.Empty;
		...
		/// <returns></returns>
		public static List<OnlineLicenseHomonEarningsOut> DataTableToList(DataTable table)
		{
			if (null != table && 0 < table.Rows.Count)
			{
				List<OnlineLicenseHomonEarningsOut> result = new List<OnlineLicenseHomonEarningsOut>();
				foreach (DataRow row in table.Rows)
				{
					OnlineLicenseHomonEarningsOut data = new OnlineLicenseHomonEarningsOut();

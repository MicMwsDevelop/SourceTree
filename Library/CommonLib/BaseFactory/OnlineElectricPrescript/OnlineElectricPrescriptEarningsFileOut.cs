//
// OnlineElectricPrescriptEarningsFileOut.cs
//
// オン資電子処方箋連携費売上情報クラス
// 
...
namespace CommonLib.BaseFactory.OnlineElectricPrescript
{
	/// <summary>
	/// オン資電子処方箋連携費売上情報
	/// </summary>
	public class OnlineElectricPrescriptEarningsFileOut
	{
		/// <summary>
		/// 018476 ｵﾝﾗｲﾝ資格確認電子処方箋連携費 330,000円（税抜）
		/// </summary>
		public const string オン資電子処方箋連携費_商品コード = "018476";
		...
		/// デフォルトコンストラクタ
		/// </summary>
		public OnlineElectricPrescriptEarningsFileOut()
		{
			受付番号 = 0;
			顧客No = 0;
			顧客名 = string.Empty;
		...
		/// <returns></returns>
		public static List<OnlineElectricPrescriptEarningsFileOut> DataTableToList(DataTable table)
		{
			if (null != table && 0 < table.Rows.Count)
			{
				List<OnlineElectricPrescriptEarningsFileOut> result = new List<OnlineElectricPrescriptEarningsFileOut>();
				foreach (DataRow row in table.Rows)
				{
					OnlineElectricPrescriptEarningsFileOut data = new OnlineElectricPrescriptEarningsFileOut();

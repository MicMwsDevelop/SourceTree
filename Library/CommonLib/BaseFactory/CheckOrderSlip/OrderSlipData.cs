...
namespace CommonLib.BaseFactory.Junp.CheckOrderSlip
{
	/// <summary>
	/// 受注伝票情報
	/// </summary>
	public class OrderSlipData
	{
		...
		public bool IsError
		{
			get
			{
				return (0 < ErrorList.Count) ? true : false;
			}
		}
		...
		/// <param name="list"></param>
		/// <returns>結果</returns>
		public static List<OrderSlipData> SelectMainte72(List<OrderSlipData> list)
		{
			return list.FindAll(p => PcaGoodsIDDefine.PaletteES_Mainte72 == p.商品コード);
		}
		...
		/// <param name="list"></param>
		/// <returns>結果</returns>
		public static List<OrderSlipData> SelectMainte12(List<OrderSlipData> list)
		{
			return list.FindAll(p => PcaGoodsIDDefine.PaletteES_Mainte12 == p.商品コード);
		}
		...
		/// <param name="target"></param>
		/// <returns>結果</returns>
		public static OrderSlipData GetSamePaletteES(List<OrderSlipData> list, OrderSlipData target)
		{
			if (PcaGoodsIDDefine.PaletteES_Mainte12 == target.商品コード || PcaGoodsIDDefine.PaletteES_Mainte72 == target.商品コード)
			{
				return list.Find(p => target.受注番号 == p.受注番号 && PcaGoodsIDDefine.PaletteES_2019 == p.商品コード);
			}
			return null;
		}

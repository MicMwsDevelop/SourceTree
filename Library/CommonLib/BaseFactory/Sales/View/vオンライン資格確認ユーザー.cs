...
namespace CommonLib.BaseFactory.Sales.View
{
	public class vオンライン資格確認ユーザー 
	{
		...
		/// <returns></returns>
		public static List<vオンライン資格確認ユーザー> DataTableToList(DataTable table)
		{
			List<vオンライン資格確認ユーザー> result = new List<vオンライン資格確認ユーザー>();
			if (null != table && 0 < table.Rows.Count)
			{
				foreach (DataRow row in table.Rows)
				{
					vオンライン資格確認ユーザー data = new vオンライン資格確認ユーザー();

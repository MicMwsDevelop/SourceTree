...
{
	public class HardSubscEarningsOut
	{
		/// <summary>
		/// 顧客No
		/// </summary>
		...
		/// <returns></returns>
		public static List<HardSubscEarningsOut> DataTableToList(DataTable table)
		{
			if (null != table && 0 < table.Rows.Count)
			{
				List<HardSubscEarningsOut> result = new List<HardSubscEarningsOut>();
				foreach (DataRow row in table.Rows)
				{
					HardSubscEarningsOut data = new HardSubscEarningsOut();

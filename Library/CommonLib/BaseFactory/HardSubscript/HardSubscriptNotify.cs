...
namespace CommonLib.BaseFactory.HardSubscript
{
	public class HardSubscriptNotify
	{
		/// <summary>
		/// 内部契約番号
		/// </summary>
		...
		/// <returns>HardSubscriptNotify</returns>
		public static List<HardSubscriptNotify> DataTableToList(DataTable table)
		{
			if (null != table && 0 < table.Rows.Count)
			{
				List<HardSubscriptNotify> result = new List<HardSubscriptNotify>();
				foreach (DataRow row in table.Rows)
				{
					HardSubscriptNotify data = new HardSubscriptNotify
					{

...
namespace CommonLib.BaseFactory.PurchaseTransfer
{
	public class 仕入商品情報 : ICloneable, IEquatable<仕入商品情報>
	{
		...
		/// <summary>
		/// TMP_Office365商品 INSERT INTO SQL文字列の取得
		/// </summary>
		public static string InsertIntoSqlString_Office365商品
		{
			get
			{
				return @"INSERT INTO TMP_Office365商品 (Palette商品コード, 商品コード, 仕入商品コード, 仕入価格, 仕入先) VALUES (@1, @2, @3, @4, @5)";
			}
		}

		/// <summary>
		/// TMP_Office365商品 CREATE TABLE SQL文字列の取得
		/// </summary>
		public static string CreateTableString_Office365商品
		{
			get
			{
				return "CREATE TABLE [dbo].[TMP_Office365商品]([Palette商品コード][nvarchar](50) NULL, [商品コード] [nvarchar](50) NULL, [仕入商品コード] [nvarchar](50) NULL, [仕入価格] [int] NULL, [仕入先] [nvarchar](50) NULL) ON [PRIMARY]";
			}
		}

		/// <summary>
		/// TMP_Office365商品 DROP TABLE SQL文字列の取得
		/// </summary>
		public static string DropTableString_Office365商品
		{
			get
			{
				return "IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TMP_Office365商品]') AND type in (N'U')) DROP TABLE [dbo].[TMP_Office365商品]";
			}
		}

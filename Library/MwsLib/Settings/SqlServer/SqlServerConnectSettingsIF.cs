//
// SqlServerConnectSettingsIF.cs
// 
// SQL Server 接続情報インターフェイス
// 
...
namespace MwsLib.Settings.SqlServer
{
	...
	public static class SqlServerConnectSettingsIF
	{
		...
		public static SqlServerConnectSettings GetSettings(bool reload = false)
		{
			SetSettingsFileName();
		...
		public static void SetSettings(SqlServerConnectSettings settings)
		{
			SetSettingsFileName();

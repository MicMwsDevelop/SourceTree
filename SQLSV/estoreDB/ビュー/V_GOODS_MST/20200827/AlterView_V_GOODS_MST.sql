...
/*
      ...
      2020/08/27 estore入替作業に伴い、BO_ORDER_UNITフィールドの追加 by 勝呂
*/
AS
...
WHERE NOT ((WebSMS.商品コード = '003501' AND OS明細印字.fmsコード = '003') OR (WebSMS.商品コード = '003502' AND OS明細印字.fmsコード = '003') OR (WebSMS.商品コード = '003503' AND OS明細印字.fmsコード = '003') OR (WebSMS.商品コード = '003504' AND OS明細印字.fmsコード = '003'))
GO

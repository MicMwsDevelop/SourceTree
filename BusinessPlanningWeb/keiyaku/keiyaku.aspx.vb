...
LBL_EXIT:
    ...
    Protected Sub B_新規登録_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles B_新規登録.Click
        ...
        strSQL = "SELECT * FROM keiyaku_table WHERE 顧客No ='" & T_顧客No.Text & "';"
        ...
        If dsUser.Tables(0).Rows.Count > 0 Then
            cnn.Close()
            lblError.Text = "対象のユーザーはすでに登録済みです。"
            GoTo LBL_EXIT
        ...
        'レコード追加
        SQL.CommandText = "INSERT INTO [keiyaku_table] ([伝票No],[顧客No],[顧客名],[担当部署コード],[担当部署名],[担当者名],[登録日],[備考]) VALUES (" & T_伝票No.Text & "," & T_顧客No.Text & ",'" & T_顧客名.Text & "','" & T_担当部署コード.Text & "','" & T_担当部署名.Text & "','" & T_担当者.Text & "','" & T_作業予定日.Text & "','" & T_備考.Text & "');"
        ...
        Response.Redirect("keiyakuMenu.aspx")

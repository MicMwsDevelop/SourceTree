<%@ Page Language="VB" MaintainScrollPositionOnPostback="True" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="Online_User.aspx.vb" Inherits="Online_Onlinet" title="電子レセプト対応進捗状況" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderbody" Runat="Server">
    ...
    <p>
        <asp:Label ID="Label3" runat="server" BackColor="#666666" Font-Bold="True" 
            Font-Size="XX-Large" ForeColor="White" Text=" 電子レセプト対応_ユーザー作業" Font-Italic="True" 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        　　<asp:Label ID="Label13" runat="server" Text="発送依頼者者検索:"></asp:Label>
        <asp:TextBox ID="T_作業担当" runat="server" AutoPostBack="True" Width="84px">%</asp:TextBox>
        <br />
        <asp:Label ID="Label1" runat="server" Text="営業担当者検索:"></asp:Label>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="都道府県名" HeaderText="都道府県" SortExpression="都道府県名" />
            <asp:BoundField DataField="発送依頼者" HeaderText="発送依頼者" SortExpression="発送依頼者" />
            <asp:BoundField DataField="発送日" DataFormatString="{0:yyyy/MM/dd}" 
                HeaderText="発送日" SortExpression="発送日" />
            ...
            <asp:BoundField DataField="作業区分" HeaderText="区分" SortExpression="作業区分" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Online_U_View] WHERE (([支店名] LIKE '%' + @支店名 + '%') AND ([発送担当] LIKE '%' + @発送担当 + '%') AND ([顧客NO] LIKE '%' + @顧客NO + '%') AND ([営業担当] LIKE '%' + @営業担当 + '%'))">
        <SelectParameters>
            <asp:ControlParameter ControlID="D_拠点" Name="支店名" PropertyName="SelectedValue" 
                Type="String" />
            <asp:ControlParameter ControlID="T_作業担当" Name="発送担当" PropertyName="Text" 
                Type="String" />
            <asp:ControlParameter ControlID="T_UserNo" Name="顧客NO" PropertyName="Text" 
                Type="String" />
            <asp:ControlParameter ControlID="T_営業担当" Name="営業担当" PropertyName="Text" 
                Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />

<%@ Page Language="VB" MaintainScrollPositionOnPostback="True" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="Online.aspx.vb" Inherits="Online_Onlinet" title="電子レセプト対応進捗状況" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderbody" Runat="Server">
    ...
    <p>
        <asp:Label ID="Label3" runat="server" BackColor="#666666" Font-Bold="True" 
            Font-Size="XX-Large" ForeColor="White" Text=" 電子レセプト対応進捗状況" Font-Italic="True" 
    ...
    <p>
        ...
        <asp:DropDownList ID="D_拠点" runat="server" AutoPostBack="True">
            ...
            <asp:ListItem>関西第一支店</asp:ListItem>
            <asp:ListItem>関西第二支店</asp:ListItem>
            <asp:ListItem>関西第三支店</asp:ListItem>
            <asp:ListItem>金沢営業所</asp:ListItem>
            <asp:ListItem>広島支店</asp:ListItem>
            <asp:ListItem>福岡支店</asp:ListItem>
        </asp:DropDownList>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label5" runat="server" Text="エントリー/本登録"></asp:Label>
        <asp:DropDownList ID="D_エントリー" runat="server" AutoPostBack="True">
            <asp:ListItem Value="%">すべて</asp:ListItem>
            <asp:ListItem Value="○">本登録</asp:ListItem>
            <asp:ListItem Value="×">エントリーのみ</asp:ListItem>
        </asp:DropDownList>
    &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="受付日" DataFormatString="{0:yyyy/MM/dd}" 
                HeaderText="受付日" SortExpression="受付日" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [支店名], [顧客NO], [顧客名１], [都道府県名], [受付日], [伝票No], [受付担当者], [作業担当者], [備考] FROM [Online_View] WHERE (([支店名] LIKE '%' + @支店名 + '%') AND ([作業区分] LIKE '%' + @作業区分 + '%') AND ([登録] LIKE '%' + @登録 + '%') AND ([顧客NO] LIKE '%' + @顧客NO + '%') AND ([担当] LIKE '%' + @担当 + '%') AND ([作業担当] LIKE '%' + @作業担当 + '%')) ORDER BY [受付日]">
        <SelectParameters>

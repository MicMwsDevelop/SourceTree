<%@ Page Language="VB" MaintainScrollPositionOnPostback="True" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="Online_Check.aspx.vb" Inherits="Online_Onlinet" title="電子レセプト対応進捗状況" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderbody" Runat="Server">
    ...
    <p>
        <asp:Label ID="Label3" runat="server" BackColor="#666666" Font-Bold="True" 
            Font-Size="XX-Large" ForeColor="White" Text=" 電子レセプト_伝票承認チェック" Font-Italic="True" 
     ...
     <br class="style1"/>
     <span class="style1">■[作業区分]が"ミック"→【ミック担当者による作業】
     </span>
     <br class="style1"/>
     <span class="style1">■[作業完了フラグ]が"終了済"→　終了チェックあり </span>
     <br class="style1"/>
     <span class="style1">■対象伝票が売上未承認
     </span>
     <br class="style1"/>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="顧客名１" HeaderText="顧客名１" SortExpression="顧客名１" />
            <asp:BoundField DataField="都道府県名" HeaderText="都道府県名" SortExpression="都道府県名" />
            <asp:BoundField DataField="f担当者名" HeaderText="受注担当者" SortExpression="f担当者名" />
            <asp:BoundField DataField="f受注番号" HeaderText="伝票No" SortExpression="f受注番号" />
            <asp:BoundField DataField="f金額" DataFormatString="{0:c}" HeaderText="金額" 
                SortExpression="f金額" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Online_Check_View] WHERE (([支店名] LIKE '%' + @支店名 + '%') AND ([顧客NO] LIKE '%' + @顧客NO + '%') AND ([登録] = @登録))">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="T_UserNo" Name="顧客NO" PropertyName="Text" 
                Type="String" />
            <asp:Parameter DefaultValue="○" Name="登録" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <br />
</asp:Content>

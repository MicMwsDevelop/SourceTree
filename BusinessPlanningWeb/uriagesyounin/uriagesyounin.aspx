<%@ Page Language="VB" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="uriagesyounin.aspx.vb" Inherits="uriagesyounin_uriagesyounin" title="WonderWeb販売管理－受注残一覧" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderbody" Runat="Server">
	...
	<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" 
		Text="WonderWeb販売管理－当月売上承認　/">
	</asp:Label>
	</span></b>
	<asp:HyperLink ID="HyperLink1" runat="server" 
		NavigateUrl="http://wwsv/businessplanningweb/misyounin/misyounin.aspx" 
		style="font-weight: 700">WonderWeb販売管理－受注残(受注未承認/受注承認)一覧 
	</asp:HyperLink>
	</p>
	<p>
	...
	<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
		...
		ShowFooter="True" ForeColor="Black" AllowSorting="true">
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
		...
		SelectCommand="SELECT [拠点名], [担当者], [納期], [販売先], [ユーザー], [受注金額], [受注No], [受注日], [出荷完了日], [売上承認日], [入金予定日], [件名], [リプレース], [ES本数], [ｻｰﾋﾞｽ利用期間]　FROM [vUriagesyounin] WHERE (([拠点名] LIKE '%' + @拠点名 + '%') AND ([伝票種別] LIKE '%' + @伝票種別 + '%') AND ([エリア] LIKE '%' + @エリア + '%') AND ([リプレース有無] LIKE '%' + @リプレース有無 + '%') AND ([件名] LIKE '%' + @件名 + '%')) ORDER BY [拠点コード], [売上承認日]">
		<SelectParameters>

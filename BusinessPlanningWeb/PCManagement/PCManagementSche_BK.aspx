<%@ Page Language="VB" MaintainScrollPositionOnPostback="True" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="PCManagementSche_BK.aspx.vb" Inherits="schedule_Scheduleselect" title="案件新規登録" %>
    ...
    使用ハード：<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="名称">
                <ItemTemplate>
                    <asp:Label ID="T_名称" runat="server" Text='<%# Eval("名称") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>

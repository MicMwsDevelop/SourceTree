...
Partial Class marks_marks
    ...
    If Me.IsPostBack = False Then
      ...
      For i = 1 To 30
        ...
        If DateTime.Now.Year = nouki.Year And DateTime.Now.Month = nouki.Month Then
          index = i
        End If
        nouki = nouki.AddMonths(1)
      Next
      D_納期.SelectedIndex = index
    End If
  ...
  Protected Sub SqlDataSource1_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs) Handles SqlDataSource1.Selected
    ...
    Protected Sub GridViewMarks_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridViewMarks.RowDataBound
    ...
    Response.AddHeader("content-disposition", "attachment;filename=MarksList.xls")
    Response.Charset = ""
        Page.EnableViewState = False
        Controls.Add(frm)
        frm.Controls.Add(GridViewMarks)
        frm.RenderControl(hw)
        Response.Write(tw.ToString())

        Response.End()

        'GridViewMarks.AllowPaging = True
        'GridViewMarks.AllowSorting = True

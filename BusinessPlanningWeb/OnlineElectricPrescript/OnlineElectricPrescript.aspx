<%@ Page Language="VB" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="OnlineElectricPrescript.aspx.vb" Inherits="OnlineElectricPrescript_OnlineElectricPrescript" title="オン資電子処方箋連携費顧客一覧" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderbody" Runat="Server">
	...
	<br />
	<asp:Label ID="LabelTitle" runat="server" Font-Bold="True" Font-Size="Large" Text="オン資電子処方箋連携費顧客一覧" />
	&nbsp;&nbsp;&nbsp;&nbsp;
	</p>
	<p>
	...
	<br /><br />
	<asp:Label ID="labelMsg1" runat="server" ForeColor="Red" Text="カードリーダーの情報は、オンライン資格確認電子処方箋連携費の申込時点のものになります。" />
	<br />
	...
	<p>
	<asp:GridView ID="GridViewOnlineElectricPrescript" runat="server" AutoGenerateColumns="False"
		BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px"
		CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSourceOnlineElectricPrescript" Font-Size="Small"
	...
	<asp:SqlDataSource ID="SqlDataSourceOnlineElectricPrescript" runat="server"
		ConnectionString="<%$ ConnectionStrings:CharlieDBConnectionString %>"
		SelectCommand="SELECT [営業部コード],[営業部名],[拠点コード],[拠点名],[顧客No],[顧客名],[商品コード],[商品名],iif([カードリーダー申込数]=0, '無', str([カードリーダー申込数])) as カードリーダー,[売上金額],CONVERT(Date, [申込日時]) as 申込日,CONVERT(Date, [売上日時]) as 売上日 FROM [vBPW_オン資電子処方箋連携費顧客一覧] WHERE ([営業部名] LIKE '%' + @SC + '%') AND ([拠点名] LIKE '%' + @オフィス + '%') ORDER BY [営業部コード],[拠点コード],[申込日],[顧客No]">
		<SelectParameters>

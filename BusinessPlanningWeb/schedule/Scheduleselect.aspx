<%@ Page Language="VB" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="Scheduleselect.aspx.vb" Inherits="schedule_Scheduleselect" title="案件新規登録" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderbody" Runat="Server">
    ...
    <br />
    <asp:Label ID="Label6" runat="server" Text="作業方法"></asp:Label>
    <br />
    <asp:DropDownList ID="D_作業方法" runat="server">

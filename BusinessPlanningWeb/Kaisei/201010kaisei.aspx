<%@ Page Language="VB" MasterPageFile="~/BusinessPlanningWeb.master" AutoEventWireup="false" CodeFile="201010kaisei.aspx.vb" Inherits="Hosyu_Hosyu_Info" title="保守未リプレース先ユーザー" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderbody" Runat="Server">
    ...
    <asp:Label ID="Label3" runat="server" BackColor="#666666" Font-Bold="True" 
            Font-Size="XX-Large" ForeColor="White" Text="2010/10金パラ対応" Font-Italic="True" 
    ...
    <br class="style1"/>
     ...
     <br class="style1"/>
     <span class="style1">■入金発送{ check有=保守には加入せず、請求書支払いにて改正ディスク発送} </span>
     <br class="style1"/>
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Kaisei201010_View] WHERE (([支店] LIKE '%' + @支店 + '%') AND ([得意先No] LIKE '%' + @得意先No + '%'))">
            <SelectParameters>

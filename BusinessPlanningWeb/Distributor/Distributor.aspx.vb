...
Partial Class Distributor_Distributor
    ...
    If Me.IsPostBack = False Then
      '最初のロードの時に表示
      Dim startYear As Integer : startYear = DateTime.Now.Year
      Dim endYear As Integer : endYear = DateTime.Now.Year
      If DateTime.Now.Month < 8 Then
        startYear = startYear - 1
      Else
        endYear = endYear + 1
      End If
      Dim startDate As New DateTime(startYear, 8, 1)
      Dim endDate As New DateTime(endYear, 7, 31)
      T_開始.Text = Format(startDate, "yyyy/MM/dd")
      T_終了.Text = Format(endDate, "yyyy/MM/dd")
    End If
